...
class SchlaegerPlayer extends StatelessWidget {
  ...
  Widget _team(
    int playerId,
    BoardData<SchlaegerSettings, SchlaegerScore> data,
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          Progress(progress(), bottom: position < 2, flip: position % 2 != 0),
          PositionedMargin(
            margins: nameMargin,
            child: GestureDetector(
              onTap: () => editNameDialog(playerId),
              child: Text(
                data.score.playerName[playerId],
